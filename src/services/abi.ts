...
export const hedronStakeABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint40', name: 'stakeId', type: 'uint40' },
      { indexed: true, internalType: 'uint40', name: 'liquidationId', type: 'uint40' }
    ],
...
export const ICSA_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint256', name: 'stakeDay', type: 'uint256' }
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'data', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'payoutIcsa', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'payoutHdrn', type: 'uint256' },
      { indexed: true, internalType: 'uint256', name: 'stakeDay', type: 'uint256' }
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'bool', name: 'isActive', type: 'bool' },
      { internalType: 'uint80', name: 'payoutPreCapitalAddIcsa', type: 'uint80' },
      { internalType: 'uint80', name: 'payoutPreCapitalAddHdrn', type: 'uint80' },
