...
import { BanknotesIcon, Bars3Icon, Squares2X2Icon, UserIcon, XMarkIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <>
      <div
        ...
        } h-screen bg-background-3 z-10 ease-in-out duration-300 overflow-hidden`}>
        <button
